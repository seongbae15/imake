  ...
  public: {
    Tables: {
      ...
      gpt_ideas_likes: {
        ...
        Relationships: [
          {
            foreignKeyName: "gpt_ideas_likes_gpt_idea_id_gpt_ideas_pg_idea_id_fk";
            columns: ["gpt_idea_id"];
            isOneToOne: false;
            referencedRelation: "gpt_ideas";
            referencedColumns: ["pg_idea_id"];
          },
          {
      ...
      messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "messages_message_id_message_rooms_message_room_id_fk";
            columns: ["message_id"];
            isOneToOne: false;
            referencedRelation: "message_rooms";
            referencedColumns: ["message_room_id"];
          ...
          {
            foreignKeyName: "messages_send_id_profiles_profile_id_fk";
            columns: ["send_id"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["profile_id"];
      ...
      notifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "notifications_post_id_post_post_id_fk";
            columns: ["post_id"];
            isOneToOne: false;
      ...
      post: {
        ...
        Relationships: [
          {
            foreignKeyName: "post_profile_id_profiles_profile_id_fk";
            columns: ["profile_id"];
            isOneToOne: false;
            referencedRelation: "profiles";
            referencedColumns: ["profile_id"];
          ...
          {
            foreignKeyName: "post_topic_id_topics_topic_id_fk";
            columns: ["topic_id"];
            isOneToOne: false;
      ...
      post_replies: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "post_replies_post_id_post_post_id_fk";
            columns: ["post_id"];
            isOneToOne: false;
            referencedRelation: "community_post_list_view";
            referencedColumns: ["post_id"];
      ...
      post_upvotes: {
        ...
        Relationships: [
          {
            foreignKeyName: "post_upvotes_post_id_post_post_id_fk";
            columns: ["post_id"];
            isOneToOne: false;
            referencedRelation: "community_post_list_view";
            referencedColumns: ["post_id"];
