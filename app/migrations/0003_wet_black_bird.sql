CREATE TABLE "gpt_ideas" (
	"pg_idea_id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "gpt_ideas_pg_idea_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START WITH 1 CACHE 1),
	"idea" text NOT NULL,
...
ALTER TABLE "gpt_ideas_likes" ADD CONSTRAINT "gpt_ideas_likes_gpt_idea_id_gpt_ideas_pg_idea_id_fk" FOREIGN KEY ("gpt_idea_id") REFERENCES "public"."gpt_ideas"("pg_idea_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
