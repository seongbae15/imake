      ...
      <Card>
        <CardHeader className="flex flex-row items-center gap-4">
          ...
          <div className="flex flex-col gap-0">
            <CardTitle className="text-xl">Seongbae</CardTitle>
      ...
      <div className="py-10 overflow-y-scroll flex flex-col justify-start h-full">
        {Array.from({ length: 10 }).map((_, index) => (
          <MessageBubble
            ...
            avatarFallback="SB"
            content="This is a message from seongbae in iMake, make sure to reply because if you don't, you will be punished"
