...
ALTER TABLE "messages" ADD CONSTRAINT "messages_message_id_message_rooms_message_room_id_fk" FOREIGN KEY ("message_id") REFERENCES "public"."message_rooms"("message_room_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "messages" ADD CONSTRAINT "messages_send_id_profiles_profile_id_fk" FOREIGN KEY ("send_id") REFERENCES "public"."profiles"("profile_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "notifications" ADD CONSTRAINT "notifications_post_id_post_post_id_fk" FOREIGN KEY ("post_id") REFERENCES "public"."post"("post_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
